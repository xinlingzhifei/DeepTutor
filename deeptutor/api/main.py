...
def _register_classroom_export_routes(
    application: FastAPI,
    *,
    enabled: bool,
    dependencies: list[object],
    ...
    if not enabled:
        return False
    from deeptutor.api.routers import classroom_exports

    application.include_router(
        classroom_exports.router,
        prefix="/api/v1",
        tags=["classroom-exports"],
        dependencies=dependencies,
    )
    return True
...
def _register_teaching_catalog_routes(
    ...
    *,
    ...
    application.include_router(
        teaching_catalog.router,
        prefix="/api/v1/teaching",
        tags=["teaching-catalog"],
        dependencies=dependencies,
    )
    return True
...
def _register_classroom_review_routes(
    ...
    *,
    ...
    application.include_router(
        classroom_reviews.router,
        prefix="/api/v1",
        tags=["classroom-reviews"],
        dependencies=dependencies,
    )
    return True


def _register_classroom_learning_routes(
    application: FastAPI,
    *,
    enabled: bool,
    dependencies: list[object],
...
_register_classroom_review_routes(
    app,
    enabled=load_platform_settings().enabled,
    dependencies=_auth,
)
_register_classroom_learning_routes(
    app,
    enabled=load_platform_settings().enabled,
    dependencies=_auth,
)
