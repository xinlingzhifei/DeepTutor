...
keeps in IMA (https://ima.qq.com) and curates there. yFeiSTAI never indexes or
stores anything locally: retrieval calls IMA's ``search_knowledge`` OpenAPI and
uses a bounded read-only source fallback when a match has no snippet. yFeiSTAI's
