# yFeiSTAI v1.5.3 Release Notes

**Release Date:** 2026.07.24

A maintenance release on top of [v1.5.2](past_releases/ver1-5-2.md): code blocks are now yours to theme, My Agents connects four more coding CLIs, a new LLM provider joins the roster, and a broad sweep of chat, memory, embedding, and parsing reliability fixes lands underneath. Drop-in — no migrations.
