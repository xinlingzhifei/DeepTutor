# yFeiSTAI v1.4.7 Release Notes

**Release Date:** 2026.06.18

A focused release on top of [v1.4.6](ver1-4-6.md): your local coding agents
become something yFeiSTAI can talk to. Connect **Claude Code** or **Codex**
...
> or Codex CLI already installed on the machine running yFeiSTAI — nothing is
...
- yFeiSTAI detects an installed **Claude Code** or **Codex** and connects it as
...
- Connected Agents require the Claude Code and/or Codex CLI installed on the
  host running yFeiSTAI — they are detected, never installed for you.
