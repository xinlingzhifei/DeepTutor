...
Embedding configuration is now explicit about the exact URL yFeiSTAI will call.
...
- **Settings now shows Endpoint URL for embeddings** - the Web settings page
  labels embedding URLs as endpoint URLs and explains that yFeiSTAI posts to
