...
- **Dependency installation step** — the tour checks Python, `uv`, Node.js, and npm; installs backend requirements, installs yFeiSTAI in editable mode, and runs frontend `npm install` with live terminal output.
