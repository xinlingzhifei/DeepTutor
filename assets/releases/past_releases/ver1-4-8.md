...
Codex, select it in chat, and yFeiSTAI consults it live — its persona, library
...
yFeiSTAI chat threads into a single partner session, archived in that partner's
...
A partner conversation can now be pulled into a yFeiSTAI chat as a referenced
