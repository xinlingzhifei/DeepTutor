...
export default memo(function ChatComposer({
  ...
  const doSend = useCallback(
    (content: string): boolean => {
      ...
      // Sending can rerender the empty-state composer into the conversation
      // layout; restore focus after that update so typing can continue.
      focusTextarea();
      return true;
    },
    [canSend, focusTextarea, isConfigBlocked, onRequestConfigConfirm, onSend],
  );
